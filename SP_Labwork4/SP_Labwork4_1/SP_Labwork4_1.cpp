...
int main()
{
	...
	while (true)
	{
		printf("1 - Разархивировать\n");
		printf("2 - Архивировать\n");
		...
		case A_UNPACK:
		{
			...
			printf("Введите путь к архиву zip (Используйте обратные двойные слеши \\)\n");
			std::cout << "Путь: " << std::endl;
			scanf("%s", unpackFile);

			printf("Введите путь к папке куда произойдет разархивирование (Используйте обратные двойные слеши )\n");
			std::cout << "Путь:" << std::endl;
			scanf("%s", resultFile);

			unpack_files(unpackFile, resultFile);
			printf("Операция произошла успешно!");
			break;
		}
		case A_PACK:
		{
			...
			printf("Введите путь к файлу или директории (Используйте обратные двойные слеши)\n");
			std::cout << "Путь:" << std::endl;
			scanf("%s", packFile);

			printf("Введите путь куда будет помещен архив (.zip)\n");
			std::cout << "Путь:" << std::endl;
			scanf("%s", resultFile);
